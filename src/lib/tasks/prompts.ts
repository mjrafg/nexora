/* The two rules the management layer adds to an agent's brief. */

export const MANAGEMENT_RULE = `# Management responsibility (mandatory rule — this one comes first)
...
export const DELEGATION_RULE = `# Work you have delegated (mandatory rule)
...
export const EXECUTIVE_RULE = `# Running the company's work (mandatory rule)
...
export const TASK_EXECUTION_RULE = `# Working a task (mandatory rule)
